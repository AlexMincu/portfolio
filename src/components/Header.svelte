<div class="text-center">
	...
	<p class="text-justify">
		Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias eum aliquid dignissimos quidem
		eius officia omnis nemo reprehenderit, neque nesciunt. Asperiores sapiente ullam distinctio. Id
		quae facilis facere voluptatum accusamus.
	</p>

	<div class="flex flex-row justify-center gap-5 align-middle">
		<div class="flex flex-row justify-center gap-1 align-middle">
			<svg
				class="h-6 w-6"
				viewBox="0 0 20 20"
				version="1.1"
				...
				/><g id="SVGRepo_iconCarrier">
					<title>github [#142]</title> <desc>Created with Sketch.</desc> <defs />
			...
			>
			<a target="_blank" href="https://github.com/AlexMincu">Github</a>
		</div>
		...
		<div class="flex flex-row justify-center gap-1 align-middle">
			...
			>
			<a target="_blank" href="https://www.linkedin.com/in/alexandru-minculescu/">LinkedIn</a>
		</div>
	</div>
</div>
